...
def main():
    ...
    outputFile="/cluster/projects/nn9297k/ROHO800+/InputData/4dvar/roho800_sst_%s_to_%s.nc"%(startYear,endYear)
    if os.path.exists(outputFile): os.remove(outputFile)

    """Read the grid info from the grid file"""
    filename="/cluster/projects/nn9490k/ROHO800/Grid/ROHO800_grid_fix5.nc"
